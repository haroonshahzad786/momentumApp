...
ALLOWED_HOSTS = ['dev.api.5cl.coderio.co', 'staging.api.5cl.coderio.co', 'api.5cl.mooremomentum.com']
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[api_momentum]"
)
...
ANYMAIL = {
    "SENDGRID_API_KEY": SENGRID_API_KEY, # noqa F405
